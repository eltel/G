          ...
          <p>
            <label>
              <input
                ...
                checked={this.props.searchType === 'universe'}/>Universe
            </label>
            <label>
              <input
                type = "radio"
                ...
                onClick={this.handleRadioChange}
			          onChange={this.handleRadioChange}
                checked={this.props.searchType === 'constellation'}/>Constellations
            </label>
            <label>
              <input
                type = "radio"
                ...
                onClick={this.handleRadioChange}
			          onChange={this.handleRadioChange}
                checked={this.props.searchType === 'galaxy'}/>Galaxies
            </label>
          </p>
        </form>
      </div>       
